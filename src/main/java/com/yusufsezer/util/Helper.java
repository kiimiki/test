...
public class Helper {
    ...
    public static String DB_SOURCE = "jdbc:mysql://10.255.103.2:3306/jspDiary?useSSL=false&serverTimezone=UTC&user=test_user&password=test_password&charset=UTF-8";
